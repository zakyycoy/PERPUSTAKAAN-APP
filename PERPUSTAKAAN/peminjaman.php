...
if(isset($_POST['pinjam'])){
    ...
    // Pastikan kolom id_buku ada di tabel peminjaman lo!
    $sql_in = "INSERT INTO peminjaman (id_anggota, id_buku, id_user, tgl_pinjam, tgl_kembali, status_pinjam) 
               VALUES ('$agg', '$bk', '$usr', '$t1', '$t2', 'proses')";
    ...
    <div class="card shadow-sm border-0">
        <div class="table-responsive">
            <table class="table table-hover mb-0 align-middle text-center">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT p.*, a.nama, b.judul FROM peminjaman p 
